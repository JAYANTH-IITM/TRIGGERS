...
class TriggerTestE0(GdbSingleHartTest): #match=0
    compile_args = ("programs/trigger_6EM0.S", )
    def setup(self):
        self.gdb.load()
        self.gdb.b("main")
        self.gdb.c()
...
class TriggerTestE1(GdbSingleHartTest): #match=1
    compile_args = ("programs/trigger_6EM1.S", )
    def setup(self):
        self.gdb.load()
        self.gdb.b("main")
        self.gdb.c()
...
class TriggerTestE2(GdbSingleHartTest): #match=2
    compile_args = ("programs/trigger_6EM2.S", )
    def setup(self):
        self.gdb.load()
        self.gdb.b("main")
        self.gdb.c()
...
class TriggerTestE3(GdbSingleHartTest): #match=3
    compile_args = ("programs/trigger_6EM3.S", )
    def setup(self):
        self.gdb.load()
        self.gdb.b("main")
        self.gdb.c()
...
class TriggerTestE4(GdbSingleHartTest): #match=4
    compile_args = ("programs/trigger_6EM4.S", )
    def setup(self):
        self.gdb.load()
        self.gdb.b("main")
        self.gdb.c()
...
class TriggerTestE5(GdbSingleHartTest): #match=5
    compile_args = ("programs/trigger_6EM5.S", )
    def setup(self):
        self.gdb.load()
        self.gdb.b("main")
        self.gdb.c()
...
class TriggerTestS0(GdbSingleHartTest): #match=0
    compile_args = ("programs/trigger_6SM0.S",)
    def setup(self):
        self.gdb.load()
        self.gdb.b("main")
        self.gdb.c()
...
class TriggerTestS1(GdbSingleHartTest): #match=1
    compile_args = ("programs/trigger_6SM1.S",)
    def setup(self):
        self.gdb.load()
        self.gdb.b("main")
        self.gdb.c()
...
class TriggerTestS2(GdbSingleHartTest): #match=2
    compile_args = ("programs/trigger_6SM2.S",)
    def setup(self):
        self.gdb.load()
        self.gdb.b("main")
        self.gdb.c()
...
class TriggerTestS3(GdbSingleHartTest): #match=3
    compile_args = ("programs/trigger_6SM3.S",)
    def setup(self):
        self.gdb.load()
        self.gdb.b("main")
        self.gdb.c()
...
class TriggerTestS4(GdbSingleHartTest): #match=4
    compile_args = ("programs/trigger_6SM4.S",)
    def setup(self):
        self.gdb.load()
        self.gdb.b("main")
        self.gdb.c()
...
class TriggerTestS5(GdbSingleHartTest): #match=5
    compile_args = ("programs/trigger_6SM5.S",)
    def setup(self):
        self.gdb.load()
        self.gdb.b("main")
        self.gdb.c()
...
class TriggerTestL0(GdbSingleHartTest): #match=0
    compile_args = ("programs/trigger_6LM0.S", )
    def setup(self):
        self.gdb.load()
        self.gdb.b("main")
        self.gdb.c()
...
class TriggerTestL1(GdbSingleHartTest): #match=1
    compile_args = ("programs/trigger_6LM1.S", )
    def setup(self):
        self.gdb.load()
        self.gdb.b("main")
        self.gdb.c()
...
class TriggerTestL2(GdbSingleHartTest): #match=2
    compile_args = ("programs/trigger_6LM2.S", )
    def setup(self):
        self.gdb.load()
        self.gdb.b("main")
        self.gdb.c()
...
class TriggerTestL3(GdbSingleHartTest): #match=3
    compile_args = ("programs/trigger_6LM3.S", )
    def setup(self):
        self.gdb.load()
        self.gdb.b("main")
        self.gdb.c()
...
class TriggerTestL4(GdbSingleHartTest): #match=4
    compile_args = ("programs/trigger_6LM4.S", )
    def setup(self):
        self.gdb.load()
        self.gdb.b("main")
        self.gdb.c()
...
class TriggerTestL5(GdbSingleHartTest): #match=5
    compile_args = ("programs/trigger_6LM5.S", )
    def setup(self):
        self.gdb.load()
        self.gdb.b("main")
        self.gdb.c()
...
class TriggerTestmret(GdbSingleHartTest): 
    compile_args = ("programs/test4.S",)
    def setup(self):
        self.gdb.load()
        self.gdb.b("main")
        self.gdb.c()
...
class TriggerTest6(GdbSingleHartTest): #case3
    compile_args = ("programs/test_trigger3_1.S", )
    def setup(self):
        self.gdb.load()
        self.gdb.b("main")
        self.gdb.c()
...
class TriggerTest7(GdbSingleHartTest):
    compile_args = ("programs/type3-case1.S", )
    def setup(self):
        self.gdb.load()
        self.gdb.b("main")
        self.gdb.c()
...
class TriggerTest8(GdbSingleHartTest):
    compile_args = ("programs/check-new.S", )
    def setup(self):
        self.gdb.load()
        self.gdb.b("main")
        self.gdb.c()
...
class TriggerDmode(TriggerTest):
    ...
    def check_triggers(self, tdata1, tdata2):
        print(self.hart.xlen-5)
    ...
    def set_pending_bit(self,v1):
        p=0
        u=0
        w=0xFFFFFBFF
        v=0x100
        p=v1|v   #p=300007c0
        u=p&w    #pending bit set , count bit decremented to 0 expected value : 805307328
        return u
        
    def test(self):
        # If we want this test to run from flash, we can't have any software
        # breakpoints set.
        self.gdb.command("info register all")
        self.gdb.command("hbreak write_load_trigger")
        self.gdb.p("$pc=write_store_trigger")
        output = self.gdb.c()
        assertIn("write_load_trigger", output)
        #t=self.gdb.p("$t2")
        self.check_triggers((3<<28) | (1<<9) | (0 << 8) | (1 << 10) | (1 << 7 ) | (1 << 6), 0x300006c0)
        #output = 
        #self.gdb.command("monitor riscv icount set u 1")
        
        #self.gdb.command("set $dcsr=1073787008")
        #u=self.set_pending_bit(0x300006c0)
        #print("After Action : ",u)
        #assertNotIn("Failed", output)
        #output = self.gdb.c()
        #assertIn("breakpoint", output)
        #self.match_count_bit((3<<28) | (1<<9) | (0 << 8) | (1 << 10) | (1 << 7 ) | (1 << 6),t)
        self.gdb.command("info register all")
        #self.gdb.command("delete")
        #self.gdb.command("hbreak clear_triggers")
        #output = self.gdb.c()
        #assertIn("clear_triggers", output)
        #self.check_triggers((1<<9), 0xfeedac00)
        #self.gdb.command("delete")
        self.exit()

class ICTest(TriggerTest6): #case3
    def early_applicable(self):
        return self.hart.honors_tdata1_hmode and \
                self.hart.instruction_hardware_breakpoint_count > 0

    def check_triggers(self, tdata1_lsbs):
        dmode = 1 << (self.hart.xlen-5)
        ...
        for i in range(16):
            ...
            if tdata1 & dmode:
                ...
                print("tdata1: ",tdata1)
                print("tdata1_lsbs: ",tdata1_lsbs)
                assertEqual(tdata1 & 0xffff, tdata1_lsbs)
                #assertEqual(tdata2, tdata2)
                #assertEqual(tdata1_lsbs,tdata1_lsbs)
    ...
    def test(self):
        ...
        output = self.gdb.c()
        assertIn("write_load_trigger", output)
        self.check_triggers(((1<<6) | (1<<7) | (0 << 0) | (2 << 10) | (1 << 9)))
        self.gdb.command("info register all")
        self.gdb.command("delete")
        self.gdb.command("hbreak clear_triggers")
        output = self.gdb.c()
        assertIn("clear_triggers", output)
        #self.check_triggers((1<<9)| (1 << 8) | (1 << 10) | (1 << 7 ) | (1 << 6), 0xfeedac00)
        self.gdb.command("delete")
        self.exit()


class EM0Test(TriggerTestE0): #match=0
    ...
    def check_triggers(self, tdata1_lsbs, tdata2):
        ...
        dmode_count = 0
        i = 0
        print("tdata1_lsb before loop: ",tdata1_lsbs)
        
        for i in range(16):
            tdata1 = self.gdb.p(f"(({xlen_type} *)&data)[{2*i}]")
            print("tdata1 inside loop: ",tdata1)
            if tdata1 == 0:
                break
            tdata2 = self.gdb.p(f"(({xlen_type} *)&data)[{2*i+1}]")
            print("tdata2 inside loop: ",tdata2)
            if tdata1 & dmode:
                dmode_count += 1
            else:
                assertEqual(tdata1 & 0x44, tdata1_lsbs)
                assertEqual(tdata1, tdata2)
    ...
    def test(self):
        ...
        output = self.gdb.c()
        assertIn("write_load_trigger", output)
        self.check_triggers((1 << 6) | (1 << 2), 60600044)
        self.gdb.command("info register all")
        self.gdb.command("delete")
        self.gdb.command("hbreak clear_triggers")
        output = self.gdb.c()
        assertIn("clear_triggers", output)
        #self.check_triggers((6 << 28) | (0 << 25) | (1 << 22) | (1 << 21) | (0 << 12 ) | (0 << 7) | (1 << 6) | (1 << 2), 0xfeedac00)
        self.gdb.command("delete")
        self.exit()
        
class EM1Test(TriggerTestE1): #match=1

    def early_applicable(self):
        return self.hart.honors_tdata1_hmode and \
                self.hart.instruction_hardware_breakpoint_count > 0

    def check_triggers(self, tdata1_lsbs, t, tdata2):
        ...
        for i in range(16):
            ...
            if tdata1 & dmode:
                ...
                assertEqual(tdata1 & 0x44, tdata1_lsbs)
                assertEqual(t, tdata2)     

        assertGreater(i, 1)
        assertEqual(dmode_count, 1)
        return triggers

    def naptop_triggers(self,v1):
        t=0
        t=v1-0x303000c4
        return t
    ...
    def test(self):
        ...
        output = self.gdb.c()
        assertIn("write_load_trigger", output)
        t=self.naptop_triggers(0x606000c4)
        self.check_triggers((1 << 6) | (1 << 2), t , 0x30300000)
        self.gdb.command("info register all")
        self.gdb.command("delete")
        self.gdb.command("hbreak clear_triggers")
        output = self.gdb.c()
...
class EM2Test(TriggerTestE2): #Match=2
    def early_applicable(self):
        return self.hart.honors_tdata1_hmode and \
                self.hart.instruction_hardware_breakpoint_count > 0
    ...
    def test(self):
        ...
        output = self.gdb.c()
        assertIn("write_load_trigger", output)
        self.check_triggers((1 << 6) | (1 << 2), 0x30300040)
        self.gdb.command("info register all")
        self.gdb.command("delete")
        self.gdb.command("hbreak clear_triggers")
        output = self.gdb.c()
...
class EM3Test(TriggerTestE3): #Match=3
    ...
    def test(self):
        ...
        output = self.gdb.c()
        assertIn("write_load_trigger", output)
        self.check_triggers( (1 << 6) | (1 << 2), 0x606003C4)
        self.gdb.command("info register all")
        self.gdb.command("delete")
        self.gdb.command("hbreak clear_triggers")
        output = self.gdb.c()
...
class EM4Test(TriggerTestE4): #Match=4

    def early_applicable(self):
        return self.hart.honors_tdata1_hmode and \
                self.hart.instruction_hardware_breakpoint_count > 0

    def check_triggers(self, tdata1_lsbs, j, q):
        dmode = 1 << (self.hart.xlen-5)
    ...
    def and_triggers(self,v1,v2):
        j=0
        j = v1 & v2
        return j
    
    def tdata2_value(self,v3):
        q=0
        u=0x00004
        q=v3 & u
        return q
    ...
    def test(self):
        ...
        output = self.gdb.c()
        assertIn("write_load_trigger", output)
        q=self.tdata2_value(0x40004)
        j=self.and_triggers(0x60600244 , q)
        self.check_triggers((1 << 6) | (1 << 2), j, q)
        self.gdb.command("info register all")
        self.gdb.command("delete")
        self.gdb.command("hbreak clear_triggers")
        output = self.gdb.c()
...
class EM5Test(TriggerTestE5): #Match=5
    def early_applicable(self):
        return self.hart.honors_tdata1_hmode and \
                self.hart.instruction_hardware_breakpoint_count > 0
    ...
    def check_triggers(self, tdata1_lsbs , j , q):
        ...
        for i in range(16):
            ...
            if tdata1 & dmode:
                ...
                assertEqual(tdata1 & 0x0044, tdata1_lsbs)
                assertEqual(j, q)     #LAST CHANGE MADE HERE 
    ...
    def test(self):
        ...
        output = self.gdb.c()
        assertIn("write_load_trigger", output)
        q=self.tdata2_value(0x600060)
        j=self.and_triggers(0x606002C4 , q)
        self.check_triggers((1<<6)|(1<<2) , j , q)
        self.gdb.command("info register all")
        self.gdb.command("delete")
        self.gdb.command("hbreak clear_triggers")
...
class SM0Test(TriggerTestS0): #match=0
    def early_applicable(self):
        return self.hart.honors_tdata1_hmode and \
                self.hart.instruction_hardware_breakpoint_count > 0
    ...
    def test(self):
        ...
        output = self.gdb.c()
        assertIn("write_load_trigger", output)
        self.check_triggers(((1 << 6)|(1 << 1)), 0x60600042)
        self.gdb.command("info register all")
        self.gdb.command("delete")
        self.gdb.command("hbreak clear_triggers")
        output = self.gdb.c()
...
class SM1Test(TriggerTestS1): #match=1
    def early_applicable(self):
        return self.hart.honors_tdata1_hmode and \
                self.hart.instruction_hardware_breakpoint_count > 0
    ...
    def check_triggers(self, tdata1_lsbs ,t,tdata2):
        ...
        for i in range(16):
            ...
            if tdata1 & dmode:
                ...
                assertEqual(tdata1 & 0x42, tdata1_lsbs)
                assertEqual(t, tdata2) 
    ...
    def test(self):
        ...
        output = self.gdb.c()
        assertIn("write_load_trigger", output)
        t=self.naptop_triggers(0x606000C2)
        self.check_triggers(((1<<6) | (1<<1)),t, 0X30300060)
        self.gdb.command("info register all")
        self.gdb.command("delete")
        self.gdb.command("hbreak clear_triggers")
        output = self.gdb.c()
...
class SM2Test(TriggerTestS2): #Match=2
    def early_applicable(self):
        return self.hart.honors_tdata1_hmode and \
                self.hart.instruction_hardware_breakpoint_count > 0
    ...
    def test(self):
        ...
        output = self.gdb.c()
        assertIn("write_load_trigger", output)
        self.check_triggers( (1 << 6) | (1 << 1), 0x30300040)
        self.gdb.command("info register all")
        self.gdb.command("delete")
        self.gdb.command("hbreak clear_triggers")
        output = self.gdb.c()
...
class SM3Test(TriggerTestS3): #Match=3
    def early_applicable(self):
        return self.hart.honors_tdata1_hmode and \
                self.hart.instruction_hardware_breakpoint_count > 0
    ...
    def test(self):
        ...
        output = self.gdb.c()
        assertIn("write_load_trigger", output)
        self.check_triggers( (1 << 6) | (1 << 1), 0X706001C3)
        self.gdb.command("info register all")
        self.gdb.command("delete")
        self.gdb.command("hbreak clear_triggers")
        output = self.gdb.c()
...
class SM4Test(TriggerTestS4): #Match=4
    def early_applicable(self):
        return self.hart.honors_tdata1_hmode and \
                self.hart.instruction_hardware_breakpoint_count > 0
    ...
    def test(self):
        ...
        output = self.gdb.c()
        assertIn("write_load_trigger", output)
        q=self.tdata2_value(0x200200)
        j=self.and_triggers(0x60600242 , q)
        self.check_triggers((1 << 6) | (1 << 1),j, q)
        self.gdb.command("info register all")
        self.gdb.command("delete")
        self.gdb.command("hbreak clear_triggers")
        output = self.gdb.c()
...
class SM5Test(TriggerTestS5): #Match=5
    def early_applicable(self):
        return self.hart.honors_tdata1_hmode and \
                self.hart.instruction_hardware_breakpoint_count > 0
    ...
    def test(self):
        ...
        assertIn("write_load_trigger", output)
        q=self.tdata2_value(0x600060)
        j=self.and_triggers(0x606002C2 , q)
        self.check_triggers((1 << 6) | (1 << 1),j, q)
        self.gdb.command("info register all")
        self.gdb.command("delete")
        self.gdb.command("hbreak clear_triggers")
...
class LM0Test(TriggerTestL0): #match=0
    def early_applicable(self):
        return self.hart.honors_tdata1_hmode and \
                self.hart.instruction_hardware_breakpoint_count > 0
    ...
    def check_triggers(self, tdata1_lsbs, tdata2):
        ...
        print("Before loop tdata1_lsbs : ",tdata1_lsbs)
        print("before Loop tdata2: ",tdata2)

        dmode_count = 0
        i = 0
        for i in range(16):
            tdata1 = self.gdb.p(f"(({xlen_type} *)&data)[{2*i}]")
            print("Inside Loop  tdata1: ",tdata1)
            if tdata1 == 0:
                break
            tdata2 = self.gdb.p(f"(({xlen_type} *)&data)[{2*i+1}]")
            print("Inside Loop tdata2: ",tdata2)
            if tdata1 & dmode:
               dmode_count += 1
            else:
                assertEqual(tdata1 & 0x41, tdata1_lsbs)
                #tdata1 = tdata1 & 0xFFEFFFFF
                assertEqual(tdata1, tdata2)     #LAST CHANGE MADE HERE 
    ...
    def test(self):
        ...
        output = self.gdb.c()
        assertIn("write_load_trigger", output)
        self.check_triggers((1<<6)|(1<<0),62200041)
        self.gdb.command("info register all")
        self.gdb.command("delete")
        self.gdb.command("hbreak clear_triggers")
        output = self.gdb.c()
...
class LM1Test(TriggerTestL1): #match=1
    def early_applicable(self):
        return self.hart.honors_tdata1_hmode and \
                self.hart.instruction_hardware_breakpoint_count > 0
    ...
    def check_triggers(self, tdata1_lsbs ,t,tdata2):
        ...
        for i in range(16):
            ...
            if tdata1 & dmode:
                ...
                assertEqual(tdata1 & 0x41, tdata1_lsbs)
                assertEqual(t, tdata2)     #LAST CHANGE MADE HERE 
    ...
    def test(self):
        ...
        output = self.gdb.c()
        assertIn("write_load_trigger", output)
        t=self.naptop_triggers(0x622000C1)
        self.check_triggers((1<<6) | (1<<0),t,0x30300060)
        self.gdb.command("info register all")
        self.gdb.command("delete")
        self.gdb.command("hbreak clear_triggers")
        output = self.gdb.c()
...
class LM2Test(TriggerTestL2): #Match=2
    def early_applicable(self):
        return self.hart.honors_tdata1_hmode and \
                self.hart.instruction_hardware_breakpoint_count > 0
    ...
    def check_triggers(self, tdata1_lsbs, tdata2):
        ...
        for i in range(16):
            ...
            if tdata1 & dmode:
                ...
                assertEqual(tdata1 & 0x41, tdata1_lsbs)
                assertGreater(tdata1, tdata2)     #LAST CHANGE MADE HERE 
    ...
    def test(self):
        ...
        output = self.gdb.c()
        assertIn("write_load_trigger", output)
        self.check_triggers((1 << 6) | (1 << 0), 0x30300040)
        self.gdb.command("info register all")
        self.gdb.command("delete")
        self.gdb.command("hbreak clear_triggers")
        output = self.gdb.c()
...
class LM3Test(TriggerTestL3): #Match=3
    def early_applicable(self):
        return self.hart.honors_tdata1_hmode and \
                self.hart.instruction_hardware_breakpoint_count > 0
    ...
    def check_triggers(self, tdata1_lsbs, tdata2):
        ...
        for i in range(16):
            ...
            if tdata1 & dmode:
                ...
                assertEqual(tdata1 & 0x41, tdata1_lsbs)
                assertLess(tdata1, tdata2)     #LAST CHANGE MADE HERE 
    ...
    def test(self):
        ...
        output = self.gdb.c()
        assertIn("write_load_trigger", output)
        self.check_triggers((1 << 6) | (1 << 0), 0X706001C3)
        self.gdb.command("info register all")
        self.gdb.command("delete")
        self.gdb.command("hbreak clear_triggers")
        output = self.gdb.c()
...
class LM4Test(TriggerTestL4): #Match=4
    def early_applicable(self):
        return self.hart.honors_tdata1_hmode and \
                self.hart.instruction_hardware_breakpoint_count > 0
    ...
    def test(self):
        ...
        assertIn("write_load_trigger", output)
        q=self.tdata2_value(0x200200)
        j=self.and_triggers(0x60600241 , q)
        self.check_triggers((1 << 6) | (1 << 0),j, q)
        self.gdb.command("info register all")
        self.gdb.command("delete")
        self.gdb.command("hbreak clear_triggers")
        output = self.gdb.c()
...
class LM5Test(TriggerTestL5): #Match=5
    def early_applicable(self):
        return self.hart.honors_tdata1_hmode and \
                self.hart.instruction_hardware_breakpoint_count > 0
    ...
    def test(self):
        ...
        assertIn("write_load_trigger", output)
        q=self.tdata2_value(0x600060)
        j=self.and_triggers(0x606002C1 , q)
        self.check_triggers((1 << 6) | (1 << 0), j, q)
        self.gdb.command("info register all")
        self.gdb.command("delete")
        self.gdb.command("hbreak clear_triggers")
...
class mret_test(TriggerTestmret):
...
class Test7(TriggerTest7):
    ...
    def test(self):
        ...
        #self.gdb.command("set $mstatus = ($mstatus & ~(3 << 11)) | (3 << 11)")
        self.gdb.command("info reg mstatus")
        #self.gdb.command("set $priv  = 0")
        #self.gdb.command("info reg priv")
        #self.gdb.command("hbreak clear_triggers")
        #self.gdb.p("$pc=clear_triggers")

        #output = self.gdb.c()
        #assertIn("clear_triggers", output)
        self.gdb.command("info register all")

class Test8(TriggerTest8):
    def early_applicable(self):
        return self.hart.honors_tdata1_hmode and \
                self.hart.instruction_hardware_breakpoint_count > 0
    def check_triggers(self, tdata1, tdata2):
